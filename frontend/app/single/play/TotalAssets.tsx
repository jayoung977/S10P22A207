    ...
    return (
        <div className="row-span-1 grid grid-rows-6">
            ...
            <div className="row-start-2 row-end-7 grid grid-rows-6 m-2 border border-small-5 scale-95 hover:scale-100 ease-in-out duration-500" >
                ...
                <div className="col-span-1 flex items-center justify-center">{totalAssetData?.cash}원</div>
                <div className={`col-span-1 flex items-center justify-center ${totalAssetData?.resultProfit > 0 ? "text-red-500" : (totalAssetData?.resultProfit < 0 ? "text-blue-500" : "text-black")}`}>{totalAssetData?.resultProfit}원</div> 
                </div>
                ...
                <div className="col-span-1 flex items-center justify-center">{totalAssetData?.totalPurchaseAmount}원</div>
                <div className="col-span-1 flex items-center justify-center">{totalAssetData?.totalAsset}원</div>
                </div>
            </div>
        </div>
