        ...
        <div className="text-center bg-white rounded shadow-lg grid grid-rows-12" style={{ width: '500px', height: '300px' }}>
            ...
            <div className="row-start-7 row-end-10 flex justify-center items-center gap-4 m-3">
                <div>
                    {
                        isBuy ? (
                            <label htmlFor="number-input" className="mb-2 font-medium text-red-500 dark:text-white">매수 수량:</label>
                        ) : (
                            <label htmlFor="number-input" className="mb-2 font-medium text-blue-500 dark:text-white">매도 수량:</label>
