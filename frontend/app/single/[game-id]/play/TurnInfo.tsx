        ...
        <div className="row-start-1 row-end-2 grid grid-rows-2">
            ...
            <div className="row-span-1 grid grid-cols-3 items-center justify-center">
                <button 
                    ...
                    className="col-span-1 rounded-md text-small-3 bg-textColor-2 border border-small-3 m-2 scale-95 ease-in-out duration-500 shadow-md shadow-small-3
                ...
                <button 
                    ...
                    className="col-span-1 rounded-md text-small-1 bg-textColor-2 border border-small-1 m-2 scale-95 ease-in-out duration-500 shadow-md shadow-small-1
                ...
                <button 
                    ...
                    className="col-span-1 rounded-md text-textColor-1 bg-textColor-2 border border-textColor-1 m-1 scale-95 ease-in-out duration-500 shadow-md shadow-textColor-1  
                            hover:text-textColor-2 hover:bg-textColor-1 hover:scale-105"
                >
                    다음
                </button>
