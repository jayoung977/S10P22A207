...
export default function FundTotalAssets () {
    return (
        <div className="row-span-1 grid grid-rows-6">
            ...
            <div className="row-start-2 row-end-7 grid grid-rows-6 m-2 border-2 border-bg-small-5 shadow-lg hover:scale-105 ease-in-out duration-500" >
                <div className="row-start-1 row-end-2 grid grid-cols-2 bg-small-5 rounded-b-lg">
                ...
                <div className="row-start-4 row-end-5 grid grid-cols-2 bg-small-5 rounded-b-lg">
