    ...
    return (
        <div className="row-start-2 row-end-7">
            <div className="grid grid-cols-6 bg-small-9 rounded-xl m-1 items-center justify-center">
                ...
                <div className="col-span-4 text-end text-textColor-2 mr-2">{rawMaterialListData[turn+299].wti ? `${rawMaterialListData[turn+299].wti}$` : "값 X"}</div>
            </div>
            <div className="grid grid-cols-6 bg-small-9 rounded-xl m-1">
                ...
                <div className="col-span-4 text-end text-textColor-2 mr-2">{rawMaterialListData[turn+299].copper ? `${rawMaterialListData[turn+299].copper}$` : "값 X"}</div>
            </div>
            <div className="grid grid-cols-6 bg-small-9 rounded-xl m-1">
                <div className="col-span-2  text-center  text-textColor-2 ml-4">금</div>
                <div className="col-span-4 text-end text-textColor-2 mr-2">{rawMaterialListData[turn+299].gold ? `${rawMaterialListData[turn+299].gold}$` : "값 X"}</div>
            </div>
            <div className="grid grid-cols-6 bg-small-9 rounded-xl m-1">
                <div className="col-span-2  text-center  text-textColor-2 ml-4">밀</div>
                <div className="col-span-4 text-end text-textColor-2 mr-2">{rawMaterialListData[turn+299].wheat ? `${rawMaterialListData[turn+299].wheat}$` : "값 X"}</div>
            </div>
            <div className="grid grid-cols-6 bg-small-9 rounded-xl m-1">
