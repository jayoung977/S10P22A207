    ...
    <div className="row-span-1 grid grid-cols-12 items-center">
      ...
      <div className="col-span-3 max-w-md mx-auto">   
        ...
        <div className="flex justify-center gap-2">
          ...
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><FontAwesomeIcon icon={faMagnifyingGlass} size="xl" /></button>
        </div>
      </div>
